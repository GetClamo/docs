...
- **Docker** (for services like CEJ connector)
- **Node.js 20+**
- **Python 3.10+**
...
|---------|-------------|------|
| `clamo-web` | Next.js Frontend | Local |
| `clamo-cases` | Cases API | Local |
| `clamo-tenant` | Tenants API | Local |
| `clamo-dashboards` | Dashboards API (Rust) | Local |
| `clamo-widget-server` | Widget Server | Local |
| `javi` | Cases AI Agent | Local |
| `clamy` | Analytics AI Agent | Local |
