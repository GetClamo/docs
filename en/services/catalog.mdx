...
<CardGroup cols={2}>
  ...
  >
    **Unified AI Assistant**
    ...
    LangGraph service containing the Javi (cases), Clamy (analytics), and Luna (global) profiles with tool isolation.
  ...
  >
    **Tools Server**
    ...
    Remote tools for the AI assistant using the Olive framework.
