...
<CardGroup cols={2}>
  ...
  >
    **Asistentes IA**
    ...
    Agentes LangGraph unificados para consultas de casos (Javi), analytics (Clamy) y asistencia global (Luna).
...
| clamo-desktop-app | TypeScript | Electron | - | - |
